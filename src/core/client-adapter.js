 ...
 */
export class BaseClientAdapter {
    /**
     * 제공자 식별자
     */
    id = 'client-adapter';
     ...
     * @returns 클라이언트 요청 옵션
     */
    transformContextToRequest(context) {
        return {
            model: this.model,
     ...
     */
    transformResponseToProvider(response) {
 ...
 * ```
 */
export function createMcpToolProvider(client, options) {
